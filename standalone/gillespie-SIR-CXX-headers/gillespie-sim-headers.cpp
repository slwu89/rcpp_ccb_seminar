...
/* need the c++14 plugin for smart pointers */
// for more details on smart pointers, see "Effective Modern C++" by Scott Meyers
// [[Rcpp::plugins(cpp14)]]
...
using prng_ptr = std::unique_ptr<prng>;
 ...
 // [[Rcpp::export]]
 Rcpp::NumericMatrix gillespie_CXX_h(const Rcpp::IntegerVector& M0,
                                   const double tmax,
